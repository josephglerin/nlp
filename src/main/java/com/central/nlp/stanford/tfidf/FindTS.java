...
public class FindTS {
    ...
    static {
        ...
        props.setProperty("pos.model", "/home/dxuser/workspace/works/nlp/nlp/models/stanford/data/tagger/" +
    ...
    public FindTS(Counter<String> dfCounter) {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        FindTS summarizer = new FindTS(dfCounter);
